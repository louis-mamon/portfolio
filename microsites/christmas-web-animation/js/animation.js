...
function animation(){
	...
	$(".enjoyMoment").delay(11000).animate(
                { right:45}, {
                    duration: 1000,
                    easing: 'easeInOutExpo'
                }).delay(2000).animate(
	...
	$(".warmWishes").delay(15000).animate(
                { opacity:1, right:45}, {
                    duration: 1000,
                    easing: 'easeInOutExpo'
                }).delay(2000).animate(
	...
	//for your mp3 files
	 var audioElement = document.createElement('audio');
        audioElement.setAttribute('src', 'img/music2.mp3');
